...
aut aut aut maxime quia temporibus ut omnis`}],Dc=Mc.map(e=>({...e,comments:Rc.filter(t=>t.postId===e.id)})),jc=()=>B.jsxs("section",{className:"App",children:[B.jsx("h1",{className:"App__title",children:"Static list of posts"}),B.jsx(Tc,{posts:Dc})]});em(document.getElementById("root")).render(B.jsx(jc,{}));
